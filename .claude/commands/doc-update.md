...
description: Intelligently update project documentation to keep it in sync with code
...
🔍 检测需要更新的文档...
⚠️  发现 8 个文档需要更新：
  - README.md (最后修改: 2025-01-01, 相关代码最后修改: 2025-11-15)
  - docs/api.md (最后修改: 2025-02-01, 相关代码最后修改: 2025-11-20)
  ...

📝 开始更新文档...
  ✅ README.md - 更新功能列表、安装说明
...
🔍 检测过时文档（超过 90 天未更新）...
⚠️  发现 5 个过时文档：
  - docs/legacy-guide.md (最后修改: 2025-08-01)
  - docs/old-api.md (最后修改: 2025-07-15)
  ...

📝 更新过时文档...
  ✅ docs/legacy-guide.md - 更新内容
  ✅ docs/old-api.md - 标记为已废弃
  ...
...
2. docs/api.md
   - 更新 API 接口文档（新增 2 个接口）
   - 更新参数说明（参数变更）
   ...

💡 提示: 使用 /doc-update（不带 --dry-run）执行实际更新
```
...
📝 更新 API 文档...
  ✅ docs/api/endpoints.md - 更新接口列表
  ✅ docs/api/authentication.md - 更新认证说明
  ...
