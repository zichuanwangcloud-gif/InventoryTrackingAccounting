...
### sqli-detection
**Purpose:** SQL injection detection and prevention patterns for secure database queries

**Files:** 1 main file (~450 lines)

**Covers:**
- SQL injection attack vectors (Union-based, Boolean-based, Time-based, Error-based, Second-order)
- Detection patterns for vulnerable code
- Secure coding practices (parameterized queries, ORM patterns)
...
**Customization:** ⚠️ Update `pathPatterns` in skill-rules.json to match your database access patterns
...
**Note:** This skill is configured with **critical priority** to ensure security best practices are always considered when working with database queries.

**[View Skill →](sqli-detection/)**
